...
import { getSeni, createSeni, deleteSeni, downloadSeniTemplate, importSeni } from '../../service/AnalisisKonsideran/Ipteks';
...
export const useSeni = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await getSeni(user?.prodiId);
