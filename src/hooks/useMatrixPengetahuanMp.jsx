...
import { getMatrixPengetahuanMp, updateMatrixPengetahuanMp } from '../service/ModelKonstruksi/Matrix/MatrixPengetahuanMp';
...
export const useMatriksPengetahuanMpData = () => {
    ...
    useEffect(() => {
      const fetchMatriksPengetahuanMp = async () => {
        ...
        try {
            if (user?.prodiId) {
                const data = await getMatrixPengetahuanMp(user?.prodiId);
