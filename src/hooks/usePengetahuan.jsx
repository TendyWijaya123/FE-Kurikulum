...
import { getPengetahuan, deletePengetahuan, createPengetahuan, updatePengetahuan } from '../service/api';
...
export const usePengetahuan = () => {
  ...
  const handleCreate = async (data) => {
    try {
      ...
      showNotification(err.response?.data?.message || 'Gagal menambah data.', 'error');
      return false;
    }
  };
  ...
  const handleUpdate = async (id, data) => {
    try {
      ...
      showNotification(err.response?.data?.message || 'Gagal memperbarui data.', 'error');
      return false;
    }
  };
